//
//  RafTapGetDiscountConfirmAnalyticsEvent.swift
//  CopilotAPIAccess
//
...
public struct RafTapGetDiscountConfirmAnalyticsEvent: AnalyticsEvent {
    
    private let name = "raf_tap_get_discount_code_confirm"
